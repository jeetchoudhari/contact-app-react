...
def draw_window(red, yellow, yellow_bullets, red_bullets, yellow_health, red_health):
    ...
    WIN.blit(red_health_font, (W - red_health_font.get_width() - 10, 10))
...
def yellow_handle_movement(keys_pressed,yellow):
    ...
    if keys_pressed[pygame.K_w] and yellow.y - VEL >0:  # UP
        yellow.y -= VEL
    if keys_pressed[pygame.K_s] and yellow.y + VEL + yellow.height + 10< H :  # DOWN
        yellow.y += VEL
...
def red_handle_movement(keys_pressed,red):
    ...
    if keys_pressed[pygame.K_UP] and red.y -VEL>0:  # UP
        red.y -= VEL
    if keys_pressed[pygame.K_DOWN] and red.y + VEL + red.height+10 < H:  # DOWN
        red.y += VEL
